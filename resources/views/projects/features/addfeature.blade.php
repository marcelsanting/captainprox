<form action="{{url('/admin/feature/store')}}" method="post">
    <div class="modal-header">
        <h5 class="modal-title" id="addFeature">Add new Feature</h5>
    ...
    <div class="modal-body">
        ...
        <input type="hidden" type="text" id="project_id" name="project_id" value="{{ $project_id }}"/>

        <div class="form-group">
            <label for="title">Title</label>
            <input type="text" class="form-control" name="title" id="title" placeholder="Feature Title" required>
            @if ($errors->has('title'))
        ...
        <div class="form-group">
            ...
            <textarea name="body" id="body" class="form-control body-editor" placeholder="Enter your feature details..." rows="8" required>
            </textarea>
            @if ($errors->has('body'))
